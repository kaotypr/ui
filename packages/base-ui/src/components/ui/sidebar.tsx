...
function SidebarProvider({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: We need to pass the setOpenMobile function to the toggleSidebar function
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: We need to pass the openMobile function to the contextValue function
