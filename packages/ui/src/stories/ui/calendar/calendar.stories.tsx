...
const meta = {
	...
	argTypes: {
		...
		hideNavigation: {
			description: "Hide the navigation buttons. This prop won't disable the navigation.",
			table: {
				type: { summary: "boolean" },
				defaultValue: { summary: "false" },
				category: "React Day Picker Props",
		...
		reverseMonths: {
			description: "Render the months in reversed order (when numberOfMonths is set).",
			table: {
				type: { summary: "boolean" },
				defaultValue: { summary: "false" },
				category: "React Day Picker Props",
		...
		broadcastCalendar: {
			description: "Display the weeks in the month following the broadcast calendar.",
			table: {
				type: { summary: "boolean" },
				defaultValue: { summary: "false" },
				category: "React Day Picker Props",
		...
		dir: {
			description:
				'The text direction of the calendar. Use "ltr" for left-to-right or "rtl" for right-to-left.',
			table: {
		...
		reverseYears: {
			description: "Reverse the order of years in the dropdown when using captionLayout dropdown.",
			table: {
				type: { summary: "boolean" },
				defaultValue: { summary: "false" },
				category: "React Day Picker Props",
		...
		role: {
			description:
				'The role attribute to add to the container element. Options: "application" or "dialog".',
			table: {
		...
		dateLib: {
			description: "Replace the default date library with a custom one (experimental).",
			table: {
...
export const RangeSelection: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Calendar in range selection mode. Click to select a start date, then click again to select an end date.",
			},
		},
	},
}
...
export const WithDateRange: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Calendar with a restricted date range. Only dates from 7 days ago to 30 days from now are selectable.",
			},
		},
	},
}
...
export const FixedWeeks: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Calendar displaying always 6 weeks per month, regardless of the month's number of weeks.",
			},
		},
	},
}
