...
const meta = {
	...
	argTypes: {
		ratio: {
			description: "The aspect ratio to maintain, expressed as width/height (e.g., 16/9, 4/3, 1).",
			table: {
				type: { summary: "number" },
...
export const VideoEmbed: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "AspectRatio is perfect for maintaining video embed dimensions responsively.",
			},
		},
	},
}
