...
const meta = {
	...
	argTypes: {
		// Base UI Root props
		defaultOpen: {
			description: "Whether the dialog is initially open. Use for uncontrolled alert dialogs.",
			table: {
		...
		onOpenChange: {
			...
			table: {
				type: {
					summary: "(open: boolean, eventDetails: AlertDialog.Root.ChangeEventDetails) => void",
				},
				defaultValue: { summary: "undefined" },
		...
		defaultTriggerId: {
			description: "ID of the trigger associated with the dialog when it is initially open.",
			table: {
		...
		onOpenChangeComplete: {
			description: "Event handler called after any opening or closing animations complete.",
			table: {
		...
		triggerId: {
			description: "ID of the trigger currently associated with the dialog in controlled mode.",
			table: {
				type: { summary: "string | null" },
				defaultValue: { summary: "undefined" },
				category: "Base UI Props",
