...
export const WithMinMax: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Restrict selectable times with `minTime` and `maxTime`. Out-of-range options are disabled.",
			},
		},
	},
}
...
const ControlledWrapper = () => {
	...
	return (
		<div className="flex flex-col gap-4">
			...
			<div className="text-sm text-muted-foreground">Selected: {time ?? "None"}</div>
		</div>
	)
}
...
export const AllFeatures: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Combining multiple features: 12-hour format, seconds, 5-minute intervals, and clearable.",
			},
		},
	},
}
