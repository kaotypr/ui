...
const meta = {
	title: "UI/ContextMenu/ContextMenuItem",
	...
	parameters: {
		...
		docs: {
			description: {
				component: `An individual interactive item in the menu. Must be used within ContextMenuContent.
	...
	render: (args) => {
		...
		return (
			<ContextMenu open={open} onOpenChange={setOpen}>
				...
				<ContextMenuContent>
					<ContextMenuItem {...args} onClick={() => args.onClick?.({} as any)}>
						Copy
					</ContextMenuItem>
					<ContextMenuItem onClick={() => {}}>Cut</ContextMenuItem>
		...
		return (
			<ContextMenu open={open} onOpenChange={setOpen}>
				...
				<ContextMenuContent>
					...
					<ContextMenuItem inset>Item without icon</ContextMenuItem>
					<ContextMenuItem>
						<ClipboardTextIcon />
						Paste
					</ContextMenuItem>
