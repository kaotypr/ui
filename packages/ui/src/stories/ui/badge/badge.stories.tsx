...
const meta = {
	...
	argTypes: {
		variant: {
			...
			table: {
				type: {
					summary: '"default" | "secondary" | "destructive" | "outline" | "ghost" | "link"',
				},
...
export const Destructive: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "A destructive badge style for error states or dangerous actions.",
			},
		},
	},
}
...
export const Ghost: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "A ghost badge with no background until hovered.",
			},
		},
	},
}
