...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"Button to navigate to the previous slide. Must be used within a Carousel component. Automatically disables when at the beginning of the carousel.",
			},
		},
	},
	argTypes: {
...
export const Default: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Default previous button positioned on the left side of a horizontal carousel.",
			},
		},
	},
}
...
export const Vertical: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Previous button in a vertical carousel, positioned at the top with rotated icon.",
			},
		},
	},
}
...
export const WithCustomVariant: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Previous button with default variant instead of outline.",
			},
		},
	},
}
...
export const WithCustomSize: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "Previous button with larger icon size.",
			},
		},
	},
}
