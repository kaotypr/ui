...
const meta = {
	...
	argTypes: {
		...
		value: {
			description: "The controlled value of the input. Use with onValueChange handler.",
			table: {
				type: { summary: "number" },
				defaultValue: { summary: "undefined" },
				category: "Props",
		...
		onValueChange: {
			description: "Callback invoked when value changes. Receives the numeric value.",
			table: {
		...
		isAllowed: {
			description: "Validator function. If it returns false, changes are rejected.",
			table: {
...
export const Controlled: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "A controlled number input using React state. The value is managed externally.",
			},
		},
	},
}
...
export const WithStepper: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "A number input with custom stepper increment/decrement of 5.",
			},
		},
	},
}
...
export const WithDecimalPlaces: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "A number input with exactly 2 decimal places, showing trailing zeros.",
			},
		},
	},
}
...
export const ReadOnly: Story = {
	...
	parameters: {
		docs: {
			description: {
				story: "A read-only number input that displays a value but cannot be edited.",
			},
		},
	},
}
